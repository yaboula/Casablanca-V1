...
import { useLocaleStore, LOCALE_LABELS, type Locale } from "@/lib/i18n";
...
const NAV_ITEMS = [
  ...
  { href: "/#why", label: "Cómo funciona", icon: Sparkles },
  { href: "/catalog", label: "Reservar", icon: BookOpen },
] as const;
                  ...
                  {menuOpen && (
                    ...
                    >
                      <div className="px-4 py-3 border-b border-slate-100">
                        <p className="text-sm font-semibold text-brand-dark truncate">{session.email}</p>
                        <p className="text-xs text-brand-muted mt-0.5">
                          {session.role === "OPERATOR" ? "Operador CMN" : "Cliente"}
                        </p>
                      </div>
                ...
                <div className="space-y-3 mt-8">
                  <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-slate-50">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-semibold text-brand-dark truncate">{session.email}</p>
                      <p className="text-xs text-brand-muted">{session.role === "OPERATOR" ? "Operador CMN" : "Cliente"}</p>
                    </div>
                  </div>
