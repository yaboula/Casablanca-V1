...
import DeliveryRefresher from "./DeliveryRefresher";
...
export default async function OperatorDashboardPage() {
  const res = await serverFetch<{ data: OperatorDelivery[]; total: number }>(
    "/operator/deliveries",
  );
  ...
  return (
    <div className="max-w-lg mx-auto">
      {/* F3.1: SSE live refresh — invisible, re-fetches Server Component on DELIVERY_UPDATE */}
      <DeliveryRefresher />
