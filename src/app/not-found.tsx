  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center p-6">
      <div className="text-center max-w-sm">
        ...
        <h2 className="text-xl font-bold text-brand-dark mb-3">Ruta no encontrada</h2>
        <p className="text-sm text-brand-muted mb-8">
          Parece que te has desviado del trayecto. Esta página no existe en nuestro sistema.
        </p>
