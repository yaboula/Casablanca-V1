...
describe("operator response DTO mappers", () => {
  ...
  const reservation = {
    ...
    deskCollectionReference: "CASH-001",
    deskCollectionReceivedAt: new Date("2026-02-19T09:15:00.000Z"),
    deskCollectionAmountEurCents: 26000,
    currency: "EUR",
  ...
  it("maps delivery rows without QR, payment, or full vehicle internals", () => {
    ...
    expect(dto).toMatchObject({
      ...
      deskCollectionMethod: DeskCollectionMethod.CASH,
      deskCollectionReference: "CASH-001",
      deskCollectionReceivedAmountEUR: 260,
      currency: "EUR",
      vehicle: {
        id: vehicle.id,
        brand: "Dacia",
