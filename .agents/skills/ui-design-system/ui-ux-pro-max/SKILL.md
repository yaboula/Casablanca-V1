---
name: ui-ux-pro-max
description: Skill for ui-ux-pro-max. See the body of this file for usage guidance and operational details.
---

# ui-ux-pro-max (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `ui-ux-pro-max`.
- Cuando necesites entender las mejores prÃ¡cticas o APIs oficiales de esta herramienta.

## CuÃ¡ndo NO usarla
- Si el proyecto ya utiliza un estÃ¡ndar conflictivo (ej. open-design).
- Para intentar instalar librerÃ­as automÃ¡ticamente; **esto estÃ¡ estrictamente prohibido**.

## DocumentaciÃ³n oficial a consultar
Debes consultar obligatoriamente: UI UX Pro Max Standards
...
3. Asegurar que las implementaciones cumplan con las reglas de ui-ux-pro-max.

## Riesgos y conflictos
- Instalar dependencias no deseadas sin consultar al usuario.
- Conflictos con: open-design
