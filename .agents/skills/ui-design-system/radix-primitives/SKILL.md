...
description: Skill for radix-primitives. See the body of this file for usage guidance and operational details.
---

# radix-primitives (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `radix-primitives`.
...
Debes consultar obligatoriamente: https://www.radix-ui.com/primitives/docs/overview/introduction
...
3. Asegurar que las implementaciones cumplan con las reglas de radix-primitives.
