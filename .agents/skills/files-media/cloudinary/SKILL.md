---
name: cloudinary
description: Skill for cloudinary. See the body of this file for usage guidance and operational details.
---

# cloudinary (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `cloudinary`.
...
Debes consultar obligatoriamente: https://cloudinary.com/documentation
...
3. Asegurar que las implementaciones cumplan con las reglas de cloudinary.
