---
name: uploadthing
description: Skill for uploadthing. See the body of this file for usage guidance and operational details.
---

# uploadthing (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `uploadthing`.
...
Debes consultar obligatoriamente: https://docs.uploadthing.com/
...
3. Asegurar que las implementaciones cumplan con las reglas de uploadthing.
