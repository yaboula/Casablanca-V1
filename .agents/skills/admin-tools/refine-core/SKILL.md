---
name: refine-core
description: Skill for refine-core. See the body of this file for usage guidance and operational details.
---

# refine-core (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `refine-core`.
- Cuando necesites entender las mejores prÃ¡cticas o APIs oficiales de esta herramienta.

## CuÃ¡ndo NO usarla
- Si el proyecto ya utiliza un estÃ¡ndar conflictivo (ej. react-admin).
- Para intentar instalar librerÃ­as automÃ¡ticamente; **esto estÃ¡ estrictamente prohibido**.

## DocumentaciÃ³n oficial a consultar
Debes consultar obligatoriamente: https://refine.dev/docs/
...
3. Asegurar que las implementaciones cumplan con las reglas de refine-core.

## Riesgos y conflictos
- Instalar dependencias no deseadas sin consultar al usuario.
- Conflictos con: react-admin
