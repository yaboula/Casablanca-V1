---
name: react-admin
description: Skill for react-admin. See the body of this file for usage guidance and operational details.
---

# react-admin (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `react-admin`.
- Cuando necesites entender las mejores prÃ¡cticas o APIs oficiales de esta herramienta.

## CuÃ¡ndo NO usarla
- Si el proyecto ya utiliza un estÃ¡ndar conflictivo (ej. refine-core).
- Para intentar instalar librerÃ­as automÃ¡ticamente; **esto estÃ¡ estrictamente prohibido**.

## DocumentaciÃ³n oficial a consultar
Debes consultar obligatoriamente: https://marmelab.com/react-admin/Readme.html
...
3. Asegurar que las implementaciones cumplan con las reglas de react-admin.

## Riesgos y conflictos
- Instalar dependencias no deseadas sin consultar al usuario.
- Conflictos con: refine-core
