---
name: novu
description: Skill for novu. See the body of this file for usage guidance and operational details.
---

# novu (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `novu`.
...
Debes consultar obligatoriamente: https://docs.novu.co/
...
3. Asegurar que las implementaciones cumplan con las reglas de novu.
