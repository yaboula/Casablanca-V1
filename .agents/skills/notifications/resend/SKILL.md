---
name: resend
description: Skill for resend. See the body of this file for usage guidance and operational details.
---

# resend (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `resend`.
...
Debes consultar obligatoriamente: https://resend.com/docs
...
3. Asegurar que las implementaciones cumplan con las reglas de resend.
