---
name: playwright-cli
description: Skill for playwright-cli. See the body of this file for usage guidance and operational details.
---

# playwright-cli (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `playwright-cli`.
...
3. Asegurar que las implementaciones cumplan con las reglas de playwright-cli.
