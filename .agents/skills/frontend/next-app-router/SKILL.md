...
description: Skill for next-app-router. See the body of this file for usage guidance and operational details.
---

# next-app-router (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `next-app-router`.
...
Debes consultar obligatoriamente: https://nextjs.org/docs/app
...
3. Asegurar que las implementaciones cumplan con las reglas de next-app-router.
