---
name: tanstack-query
description: Skill for tanstack-query. See the body of this file for usage guidance and operational details.
---

# tanstack-query (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `tanstack-query`.
...
Debes consultar obligatoriamente: https://tanstack.com/query/latest
...
3. Asegurar que las implementaciones cumplan con las reglas de tanstack-query.
