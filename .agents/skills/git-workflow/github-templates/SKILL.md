...
description: Skill for github-templates. See the body of this file for usage guidance and operational details.
---

# github-templates (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `github-templates`.
...
Debes consultar obligatoriamente: https://docs.github.com/en/communities/using-templates-to-encourage-useful-issues-and-pull-requests
...
3. Asegurar que las implementaciones cumplan con las reglas de github-templates.
