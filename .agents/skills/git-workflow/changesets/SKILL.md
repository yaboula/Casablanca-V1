...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estándares de `changesets`.
- Cuando necesites entender las mejores prácticas o APIs oficiales de esta herramienta.

## Cuándo NO usarla
- Si el proyecto ya utiliza un estándar conflictivo (ej. semantic-release).
