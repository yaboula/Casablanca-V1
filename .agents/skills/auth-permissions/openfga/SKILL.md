---
name: openfga
description: Skill for openfga. See the body of this file for usage guidance and operational details.
---

# openfga (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `openfga`.
...
Debes consultar obligatoriamente: https://openfga.dev/docs
...
3. Asegurar que las implementaciones cumplan con las reglas de openfga.
