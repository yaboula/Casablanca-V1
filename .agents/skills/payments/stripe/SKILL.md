...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estándares de `stripe`.
...
Debes consultar obligatoriamente: https://stripe.com/docs
...
3. Asegurar que las implementaciones cumplan con las reglas de stripe.
