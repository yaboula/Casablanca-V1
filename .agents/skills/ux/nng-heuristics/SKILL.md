---
name: nng-heuristics
description: Skill for nng-heuristics. See the body of this file for usage guidance and operational details.
---

# nng-heuristics (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `nng-heuristics`.
...
Debes consultar obligatoriamente: https://www.nngroup.com/articles/ten-usability-heuristics/
...
3. Asegurar que las implementaciones cumplan con las reglas de nng-heuristics.
