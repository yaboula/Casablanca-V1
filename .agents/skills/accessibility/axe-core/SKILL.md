---
name: axe-core
description: Skill for axe-core. See the body of this file for usage guidance and operational details.
---

# axe-core (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `axe-core`.
...
Debes consultar obligatoriamente: https://github.com/dequelabs/axe-core
...
3. Asegurar que las implementaciones cumplan con las reglas de axe-core.
