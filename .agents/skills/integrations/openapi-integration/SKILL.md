...
description: Skill for openapi-integration. See the body of this file for usage guidance and operational details.
---

# openapi-integration (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `openapi-integration`.
...
Debes consultar obligatoriamente: https://swagger.io/specification/
...
3. Asegurar que las implementaciones cumplan con las reglas de openapi-integration.
