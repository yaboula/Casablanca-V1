---
name: mcp-protocol
description: Skill for mcp-protocol. See the body of this file for usage guidance and operational details.
---

# mcp-protocol (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `mcp-protocol`.
...
Debes consultar obligatoriamente: https://modelcontextprotocol.io/
...
3. Asegurar que las implementaciones cumplan con las reglas de mcp-protocol.
