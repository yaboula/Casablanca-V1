...
description: Skill for playwright-testing. See the body of this file for usage guidance and operational details.
---

# playwright-testing (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `playwright-testing`.
...
Debes consultar obligatoriamente: https://playwright.dev/docs/intro
...
3. Asegurar que las implementaciones cumplan con las reglas de playwright-testing.
