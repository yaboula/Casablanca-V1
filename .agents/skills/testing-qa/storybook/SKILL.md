---
name: storybook
description: Skill for storybook. See the body of this file for usage guidance and operational details.
---

# storybook (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `storybook`.
...
Debes consultar obligatoriamente: https://storybook.js.org/docs
...
3. Asegurar que las implementaciones cumplan con las reglas de storybook.
