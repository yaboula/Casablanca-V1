---
name: vitest
description: Skill for vitest. See the body of this file for usage guidance and operational details.
---

# vitest (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `vitest`.
...
Debes consultar obligatoriamente: https://vitest.dev/guide/
...
3. Asegurar que las implementaciones cumplan con las reglas de vitest.
