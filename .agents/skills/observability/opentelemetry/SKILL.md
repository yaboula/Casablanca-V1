---
name: opentelemetry
description: Skill for opentelemetry. See the body of this file for usage guidance and operational details.
---

# opentelemetry (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `opentelemetry`.
...
Debes consultar obligatoriamente: https://opentelemetry.io/docs/
...
3. Asegurar que las implementaciones cumplan con las reglas de opentelemetry.
