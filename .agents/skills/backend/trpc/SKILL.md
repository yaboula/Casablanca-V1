---
name: trpc
description: Skill for trpc. See the body of this file for usage guidance and operational details.
---

# trpc (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `trpc`.
- Cuando necesites entender las mejores prÃ¡cticas o APIs oficiales de esta herramienta.

## CuÃ¡ndo NO usarla
- Si el proyecto ya utiliza un estÃ¡ndar conflictivo (ej. fastify).
- Para intentar instalar librerÃ­as automÃ¡ticamente; **esto estÃ¡ estrictamente prohibido**.

## DocumentaciÃ³n oficial a consultar
Debes consultar obligatoriamente: https://trpc.io/docs
...
3. Asegurar que las implementaciones cumplan con las reglas de trpc.

## Riesgos y conflictos
- Instalar dependencias no deseadas sin consultar al usuario.
- Conflictos con: fastify
