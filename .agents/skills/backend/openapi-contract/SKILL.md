...
description: Skill for openapi-contract. See the body of this file for usage guidance and operational details.
---

# openapi-contract (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `openapi-contract`.
...
3. Asegurar que las implementaciones cumplan con las reglas de openapi-contract.
