---
name: docusaurus
description: Skill for docusaurus. See the body of this file for usage guidance and operational details.
---

# docusaurus (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `docusaurus`.
...
Debes consultar obligatoriamente: https://docusaurus.io/docs
...
3. Asegurar que las implementaciones cumplan con las reglas de docusaurus.
