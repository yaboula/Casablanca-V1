---
name: owasp-zap
description: Skill for owasp-zap. See the body of this file for usage guidance and operational details.
---

# owasp-zap (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `owasp-zap`.
...
Debes consultar obligatoriamente: https://www.zaproxy.org/docs/
...
3. Asegurar que las implementaciones cumplan con las reglas de owasp-zap.
