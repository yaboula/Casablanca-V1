...
description: Skill for owasp-cheat-sheets. See the body of this file for usage guidance and operational details.
---

# owasp-cheat-sheets (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `owasp-cheat-sheets`.
...
Debes consultar obligatoriamente: https://cheatsheetseries.owasp.org/
...
3. Asegurar que las implementaciones cumplan con las reglas de owasp-cheat-sheets.
