...
description: Skill for core-web-vitals. See the body of this file for usage guidance and operational details.
---

# core-web-vitals (Generated Wrapper)
...
- Cuando el flujo de trabajo, arquitectura o issue requiera consultar o aplicar estÃ¡ndares de `core-web-vitals`.
...
Debes consultar obligatoriamente: https://web.dev/explore/learn-core-web-vitals
...
3. Asegurar que las implementaciones cumplan con las reglas de core-web-vitals.
